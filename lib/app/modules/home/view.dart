...
import 'package:todo/app/modules/report/report_page.dart';
import 'package:todo/onboarding.dart';
import 'package:todo/app/core/utils/extension.dart';

class Home extends GetView<HomeController> {
  // final storageService = Get.put(StorageServices());
        ...
        builder: (_, __, ___) {
          return Obx(
            () => FloatingActionButton(
              ...
              child:
                  Icon(controller.deleteing.value ? Icons.delete : Icons.add),
            ),
          );
        },
        onAccept: (Task task) {
